...
export default function Terminos() {
  return (
    <div>
        ...
        <p>Última actualización: 06 de junio de 2024</p>
        <br />
        <p>Lea atentamente estos términos y condiciones antes de utilizar nuestro servicio.</p>
        <br />
        <h2 className='text-xl underline'>Interpretación y definiciones</h2>
        <br />
        ...
        <br />
        <ul>
            <li><strong>* Afiliada</strong> significa una entidad que controla, está controlada por o está bajo control común con una parte, donde "control" significa propiedad del 50% o más de las acciones, participación accionaria u otros valores con derecho a votar para la elección de directores u otra autoridad administrativa.</li>
            <li><strong>*País</strong> se refiere a: Paraguay</li>
            <li><strong>*Compañía</strong> (denominada "la Compañía", "Nosotros", "Nos" o "Nuestro" en este Acuerdo) se refiere a Voraz, Av San Mongelo y calle 5, Ciudad del Este, Paraguay.</li>
        ...
        <br />
        <h3 className='underline'>Reconocimiento</h3>
        ...
        <br />
        <h3 className='underline'>Enlaces a otros sitios web</h3>
        <p>Nuestro Servicio puede contener enlaces a sitios web o servicios de terceros que no son propiedad de la Compañía ni están controlados por ella.</p>
        ...
        <br />
        <h3 className='underline'>Terminación</h3>
        <p>Podemos cancelar o suspender Su acceso inmediatamente, sin previo aviso ni responsabilidad, por cualquier motivo, incluido, entre otros, si incumple estos Términos y condiciones.</p>
        <p>Tras la rescisión, su derecho a utilizar el Servicio cesará inmediatamente.</p>
        <br />
        <h3 className='underline'>Limitación de responsabilidad</h3>
        <p>Independientemente de los daños en los que pueda incurrir, la responsabilidad total de la Compañía y cualquiera de sus proveedores según cualquier disposición de estos Términos y su recurso exclusivo por todo lo anterior se limitará al monto realmente pagado por usted a través del Servicio o 100 USD. si no ha comprado nada a través del Servicio.</p>
        <p>En la máxima medida permitida por la ley aplicable, en ningún caso la Compañía o sus proveedores serán responsables de ningún daño especial, incidental, indirecto o consecuente de ningún tipo (incluidos, entre otros, daños por pérdida de ganancias, pérdida de datos o otra información, por interrupción del negocio, por lesiones personales, pérdida de privacidad que surja de o esté relacionada de alguna manera con el uso o la imposibilidad de usar el Servicio, el software de terceros y/o el hardware de terceros utilizado con el Servicio, o de otro modo en relación con cualquier disposición de estos Términos), incluso si la Compañía o cualquier proveedor han sido advertidos de la posibilidad de tales daños e incluso si el remedio no cumple con su propósito esencial.</p>
        ...
        <p>Sin limitar lo anterior, ni la Compañía ni ninguno de los proveedores de la compañía hacen ninguna representación o garantía de ningún tipo, expresa o implícita: (i) en cuanto al funcionamiento o disponibilidad del Servicio, o la información, el contenido y los materiales o productos. incluido en el mismo; (ii) que el Servicio será ininterrumpido o estará libre de errores; (iii) en cuanto a la exactitud, confiabilidad o actualidad de cualquier información o contenido proporcionado a través del Servicio; o (iv) que el Servicio, sus servidores, el contenido o los correos electrónicos enviados desde o en nombre de la Compañía están libres de virus, scripts, troyanos, gusanos, malware, bombas de tiempo u otros componentes dañinos.</p>
        ...
        <br />
        <h3 className='underline'>Ley que rige</h3>
        <p>Las leyes del País, excluyendo sus conflictos de normas legales, regirán estos Términos y Su uso del Servicio. Su uso de la Aplicación también puede estar sujeto a otras leyes locales, estatales, nacionales o internacionales.</p>
        <br />
        <h3 className='underline'>Resolución de disputas</h3>
        ...
        <br />
        <h3 className='underline'>Cumplimiento legal de Estados Unidos</h3>
        ...
        <br />
        <h3 className='underline'>Divisibilidad y renuncia</h3>
        <br />
        <h4>Divisibilidad:</h4>
        <p>Si alguna disposición de estos Términos se considera inaplicable o inválida, dicha disposición se modificará e interpretará para lograr los objetivos de dicha disposición en la mayor medida posible según la ley aplicable y las disposiciones restantes continuarán en pleno vigor y efecto.</p>
        <br />
        <h4>Exención:</h4>
        <p>Salvo lo dispuesto en el presente, el hecho de no ejercer un derecho o exigir el cumplimiento de una obligación en virtud de estos Términos no afectará la capacidad de una parte para ejercer dicho derecho o exigir dicho cumplimiento en cualquier momento posterior ni la renuncia a un incumplimiento constituirá una renuncia a cualquier incumplimiento posterior.</p>
        <br />
        <h3 className='underline'>Traducción Interpretación</h3>
        <p>Es posible que estos Términos y condiciones se hayan traducido si los hemos puesto a su disposición en nuestro Servicio. Usted acepta que el texto original en inglés prevalecerá en caso de disputa.</p>
        <br />
        <h3 className='underline'>Cambios a estos términos y condiciones</h3>
        <p>Nos reservamos el derecho, a nuestra entera discreción, de modificar o reemplazar estos Términos en cualquier momento. Si una revisión es importante, haremos esfuerzos razonables para avisar con al menos 30 días de antelación antes de que los nuevos términos entren en vigor. Lo que constituye un cambio material se determinará a Nuestro exclusivo criterio.</p>
        <p>Al continuar accediendo o utilizando Nuestro Servicio después de que esas revisiones entren en vigencia, usted acepta estar sujeto a los términos revisados. Si no acepta los nuevos términos, total o parcialmente, deje de utilizar el sitio web y el Servicio.</p>
        <br />
